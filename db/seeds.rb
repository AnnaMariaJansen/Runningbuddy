...
run_four = Run.create!(route: 'Tegernsee', length: '9km', pace: "average", duration: "60 min", date: "29.11.2020", location: "Tegernsee, Bayern, Deutschland", user_id: user_four.id)
