...
run_one = Run.create!(route: 'the block', length: '5km', pace: "4:30", duration: "not so long", user_id: user_one.id)
...
run_two = Run.create!(route: 'the park', length: '4km', pace: "4:20", duration: "not so long", user_id: user_two.id)
...
run_three = Run.create!(route: 'city center', length: '5km', pace: "4:10", duration: "roughly 25 min", user_id: user_three.id)
...
run_four = Run.create!(route: 'the mountains', length: '6km', pace: "4:30", duration: "however long it takes", user_id: user_four.id)
