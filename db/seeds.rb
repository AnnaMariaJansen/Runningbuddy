...
run_four = Run.create!(route: 'Oberammergau Mountain Trail', length: '9', pace: "average", duration: "60 min", date: "29.11.2020", location: "Kreislainenweg, 82487 Oberammergau", user_id: user_four.id)
